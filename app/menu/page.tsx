...
export default function MenuPage({ isAdmin = false }) {
              ...
              <CardHeader>
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <CardDescription>{item.calories}</CardDescription>
                  </div>
        ...
        <DialogContent className="max-w-md">
          ...
          <div className="grid gap-4 py-4">
            ...
            <div>
              ...
              <Input className="mt-1" type="text" placeholder="$0.00" />
            </div>
            <div>
              <label className="text-sm font-medium">Calories</label>
              <Input className="mt-1" type="text" placeholder="0 Calories" />
            </div>
            <div>
